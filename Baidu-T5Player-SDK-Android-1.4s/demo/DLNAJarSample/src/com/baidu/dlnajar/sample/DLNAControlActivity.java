...
public class DLNAControlActivity extends Activity implements OnClickListener {
	...
	private Handler uiHandler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case SELECT_SUC:
				...
				serviceProvider.getVolume();
				serviceProvider.stop();
				serviceProvider.setMediaURI(playUrl);
				break;
			case SET_URI_SUC:
		...
		progressSeekBar
				.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
					...
					public void onStopTrackingTouch(SeekBar seekBar) {
						// TODO Auto-generated method stub
						serviceProvider.seek(formatTime(seekBar.getProgress()));
					}
		...
		volumeSeekBar.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
			...
			public void onStopTrackingTouch(SeekBar seekBar) {
				...
				if (mVolume == volume) {
					...
					serviceProvider.setVolume(volume);
				}
			}
	...
	private void initDevice() {
		...
		alertPorgress.show();
		serviceProvider.selectRenderDevice(selectedDevice);
	}
	...
	public void onClick(View v) {
		...
		// the last show
			...
			isMute = !isMute;
			serviceProvider.setMuteStat(isMute);
